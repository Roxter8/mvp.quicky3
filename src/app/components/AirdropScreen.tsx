  ...
  return (
    <div className="min-h-screen bg-[#050B1A] pb-20">
      <div className="px-4 pt-6">
        <h1 className="text-white text-lg font-semibold">Airdrop</h1>
        ...
        <div className="rounded-2xl border border-blue-400/20 bg-blue-500/10 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-white font-medium">Token coming soon</p>
      ...
      <div className="px-4 mt-6 space-y-3">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <p className="text-white font-semibold">Quests</p>
            </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <div className="flex items-center justify-between">
            <p className="text-white font-semibold">NFT Multiplier</p>
            <span className="text-xs text-white/60">Coming soon</span>
          </div>
      ...
      <div className="px-4 mt-6">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-white font-semibold">Referrals</h2>
          <span className="text-xs text-white/60">0.1x per referral</span>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          {!isConnected ? (
            <>
              <p className="text-white/80 text-sm mb-1">Connect to get your referral link</p>
            ...
            <>
              ...
              <div className="mt-5 grid grid-cols-3 gap-2">
                <div className="rounded-xl bg-black/20 border border-white/10 p-3">
                  ...
                  <p className="text-white font-semibold mt-1">{refCount}</p>
                </div>
                <div className="rounded-xl bg-black/20 border border-white/10 p-3">
                  <p className="text-[#93A4C7] text-xs">Bonus</p>
                  <p className="text-white font-semibold mt-1">{referralMultiplier}x</p>
                </div>
                <div className="rounded-xl bg-black/20 border border-white/10 p-3">
                  <p className="text-[#93A4C7] text-xs">Total</p>
                  <p className="text-white font-semibold mt-1">{totalMultiplier}x</p>
                </div>
              </div>
